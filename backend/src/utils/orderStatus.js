...
const ORDER_STATUS_TRANSITIONS = Object.freeze({
  ...
  PACKED: new Set(['RIDER_ASSIGNED', 'OUT_FOR_DELIVERY', 'CANCELLED']),
  ...
  OUT_FOR_DELIVERY: new Set(['PICKED_UP', 'ON_THE_WAY', 'RIDER_NEARBY', 'DELIVERED', 'FAILED_DELIVERY']),
  PICKED_UP: new Set(['ON_THE_WAY', 'RIDER_NEARBY', 'DELIVERED', 'FAILED_DELIVERY']),
  ON_THE_WAY: new Set(['RIDER_NEARBY', 'DELIVERED', 'FAILED_DELIVERY']),
  RIDER_NEARBY: new Set(['DELIVERED', 'FAILED_DELIVERY']),
  DELIVERED: new Set(['REFUNDED']),
  FAILED_DELIVERY: new Set(['PACKED', 'REFUNDED', 'CANCELLED']),
