...
/// Oroshi-style horizontal scrolling category chips with 56x56 containers.
class OroshiCategoryRow extends StatelessWidget {
  const OroshiCategoryRow({
    super.key,
        ...
        if (isLoading && categories.isEmpty)
          ...
          SizedBox(
            ...
            child: ListView.separated(
              ...
              padding: const EdgeInsets.symmetric(horizontal: 16),
              itemCount: categories.isEmpty ? 4 : categories.length,
                ...
                if (categories.isEmpty) {
                  return _CategoryChip(
                    item: HomeCategoryItem(
                      id: 'default_$index',
                      name: ['Chicken', 'Eggs', 'Fish', 'Mutton'][index],
                    ),
                    onTap: () {},
                  );
                }
...
class _CategoryChip extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isActive = OroshiCategoryRow._isActive(item.name);
    final isComingSoon = OroshiCategoryRow._isComingSoon(item.name);
