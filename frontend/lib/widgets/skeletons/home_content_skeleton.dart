...
/// Feed skeleton below the location header (home / location-setup).
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: const [
                ShimmerContainer(width: 140, height: 20, borderRadius: 8),
                SizedBox(height: 10),
                ShimmerContainer(width: 180, height: 14, borderRadius: 8),
                SizedBox(height: 14),
              ],
            ),
          ),
